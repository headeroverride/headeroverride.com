...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${title} | Header Override`, description, url: pageUrl, siteName: "Header Override", type: "article", publishedTime: guideDatePublished, modifiedTime: guideDateModified, images: [{ url: "/screenshots/feature-headers-1280x800.png", width: 1280, height: 800, alt: "Header Override request header rules" }] },
  twitter: { card: "summary_large_image", title: `${title} | Header Override`, description, images: ["/screenshots/feature-headers-1280x800.png"] }
};

const articleJsonLd = { "@context": "https://schema.org", "@type": "TechArticle", headline: title, description, datePublished: guideDatePublished, dateModified: guideDateModified, url: pageUrl, image: "https://headeroverride.com/screenshots/feature-headers-1280x800.png", author: { "@type": "Organization", name: "Header Override", url: "https://headeroverride.com" }, publisher: { "@type": "Organization", name: "Header Override", logo: { "@type": "ImageObject", url: "https://headeroverride.com/icons/icon-128.png" } } };
...
export default function TestAdminPermissionsBrowserPage() {
  return <main className="legal-page guide-page"><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([articleJsonLd, breadcrumbJsonLd]) }} /><GuideNav /><article className="guide-article shell"><GuideArticleHeader category="Authentication & Cookies" description={description} pageUrl={pageUrl} readTime="6 min read" title={title} /><div className="guide-layout"><aside className="guide-aside"><p className="guide-aside-label">On this page</p><a href="#401-vs-403">401 vs 403</a><a href="#checklist">Debugging checklist</a><a href="#override">Where Header Override helps</a></aside><div className="guide-content">
